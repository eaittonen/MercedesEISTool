...
public interface IMercedesEisApiClient
{
    ...
    Task<AnalyzeDumpResponse> AnalyzeDumpAsync(byte[] data, string fileName, string vehicleIdentifier, string registrationNumber, CancellationToken cancellationToken = default);
    Task<UploadDumpResponse> UploadDumpAsync(byte[] data, string fileName, string vehicleIdentifier, string registrationNumber, CancellationToken cancellationToken = default);
